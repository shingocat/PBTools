###############################################################################
# TODO: Pyramided Line Single Site Analysis, By far, It is only
#		to accept BiGenes, TriGenes and QuadraGenes structure.
# 		If it is BiGenes, the most genotype levels are 9.
#			and the coded levels should be mandatory on 
#				"aabb" "Aabb" "AAbb" "aaBb" "AaBb" "AABb" "aaBB" "AaBB" "AABB"
#		If it is TriGenes, the most genotype levels are 27.
#			and the coded levels should be mandatory on 
# 				"aabbcc" "aabbCc" "aabbCC" "aaBbcc" "aaBbCc" "aaBbCC" "aaBBcc" "aaBBCc"
# 				"aaBBCC" "Aabbcc" "AabbCc" "AabbCC" "AaBbcc" "AaBbCc" "AaBbCC" "AaBBcc"
# 				"AaBBCc" "AaBBCC" "AAbbcc" "AAbbCc" "AAbbCC" "AABbcc" "AABbCc" "AABbCC"
# 				"AABBcc" "AABBCc" "AABBCC"
#		If it is QuadraGens, the most genotype levels are 81.
#			and the coded levels should be mandatory on 
...
pyramidedline.ssa.test <- function(
...
{
	UseMethod("pyramidedline.ssa.test");
};

pyramidedline.ssa.test.default <- function(
		exptl.design = c("RCB", "AugRCB", "AugLS", "Alpha", "RowCol", "LatinAlpha", "LatinRowCol"),
		respvar,
		geno,
		block = NULL,
